...
func input_jump_release():
	if Input.is_action_just_released("ui_up") and velocity.y < moveData.JUMP_RELEASED_FORCE:
...
func reset_double_jump():
	double_jump = moveData.DOUBLE_JUMPS
